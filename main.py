...
TIPS1=['Strategi manajemen preventif dapat mengurangi kerugian ekonomi dari NCLB. Manajemen pencegahan sangat penting untuk bidang yang berisiko tinggi untuk perkembangan penyakit. Pilihan pengelolaan penyakit dalam musim, seperti fungisida, juga tersedia.',
...
TIPS2=['Resistensi utama (vertikal) hibrida jagung berasal dari gen spesifik ras Ht1, Ht2, Ht3, dan HtN, dengan gen Ht1 yang paling umum. Tanaman dengan gen Ht1 Ht2, atau Ht3 memiliki lesi klorotik yang lebih kecil dan sporulasi yang berkurang.[2] Gen HtN menunda gejala sampai setelah serbuk sari ditumpahkan. Secara individual, masing-masing gen Ht memiliki efektivitas terbatas karena ada ras E',
...
def hasil():
    ...
    return render_template('hasil.html', penyakit=KONDISI[classes], imagepath=filepath, tips1=TIPS1[classes], tips2=TIPS2[classes])
